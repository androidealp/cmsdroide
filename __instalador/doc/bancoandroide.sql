<<<<<<< HEAD:__instalador/doc/cmsdroide.sql
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `csdm_adm_grupos` (`id`, `nome`, `menu_pervissoes`, `atrib_permissoes`) VALUES (1, 'admin', '[\"1\"]', '[\"1\"]');
...
>>>>>>> 2088f758f1e562a149fe831ca66f9ce355be4535:__instalador/doc/bancoandroide.sql
